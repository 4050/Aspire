//
//  CustomRestaurantMenuButton.swift
//  Aspire
//
//  Created by Stanislav on 31.08.2020.
//  Copyright © 2020 Stanislav. All rights reserved.
//

import UIKit

class CustomRestaurantMenuButton: UIButton {
...
extension CustomRestaurantMenuButton {
    ...
    public func ButtonEnableAnimation(titleName: String, firstImage: String, secondImage: String) {
        UIView.animate(withDuration: 0.4,
                       ...
                       animations: {
                        ...
                        self.layer.frame.size = CGSize(width: 121.0, height: 44.0)
    ...
    public func ButtonDisableAnimation(titleName: String, firstImage: String, secondImage: String) {
        UIView.animate(withDuration: 0.4,
                       ...
                       options: .curveEaseInOut,
                       animations: {
                        self.layer.frame.size = CGSize(width: 56.0, height: 44.0)
